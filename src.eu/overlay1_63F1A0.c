...
s16  func_80130908(s16 language, s16 level, u16 *msg_lengths, s16 *dst);
s16 *func_80130AB0(s16);
...
u8 language_select_menu(s16 arg0) {
    ...
    if (arg0 == 0) {
        ...
        for (sp84 = 0; sp84 < 9; sp84++) {
            func_80130908(sp84, 0x20, &D_8022E410.unk36B0, &D_8022E410.unk396C);
            if ((sp84 != 6) && (sp84 != 0)) {
                sp80 = func_80130AB0(MSG_LANGUAGE);
