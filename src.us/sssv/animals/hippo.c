    ...
    if (spFA == 0) {
        ...
        if (D_803D552C->unk365 == 0x11) {
            ...
            if (var_t5 >= 0xA) {
                ...
                // temp_v0_8 = D_801D9E88;
                // D_801D9E88 = temp_v0_8 + 8;
                // temp_v0_8->unk0 = 0x06000000;
                // temp_v0_8->unk4 = 0x01003548;
                gSPDisplayList(D_801D9E88++, D_01003548);
                // temp_v0_9 = D_801D9E88;
                // D_801D9E88 = temp_v0_9 + 8;
                // temp_v0_9->unk0 = 0xFA000000;
                // temp_v0_9->unk4 = 0xB4FFB4FF;
                ...
                // temp_v0_10 = D_801D9E88;
                // D_801D9E88 = temp_v0_10 + 8;
                // temp_v0_10->unk0 = 0x01040040;
                // // temp_t2_2 = D_80204278;
                // temp_v0_10->unk4 = (void *) (;
                // // temp_t2_3 = D_80204278;
                ...
                switch (var_t5) {
                case 10:
                    // temp_v0_11 = D_801D9E88;
                    // D_801D9E88 = temp_v0_11 + 8;
                    // temp_v0_11->unk0 = 0x06000000;
                    // temp_v0_11->unk4 = 0x0400B420;
...
//                     var_v0_2 = D_801D9E88;
//                     var_t7 = 0x0400B470;
//                     D_801D9E88 = var_v0_2 + 8;
//                     var_v0_2->unk0 = 0x06000000;
// block_48:
//                     var_v0_2->unk4 = var_t7;
                ...
                case 12:
                    ...
                    // temp_v0_12->unk4 = 0x0400B4C0;
                    gSPDisplayList(D_801D9E88++, D_0400B4C0);
                    break;
                case 13:
                    // temp_v0_13 = D_801D9E88;
                    // D_801D9E88 = temp_v0_13 + 8;
                    // temp_v0_13->unk0 = 0x06000000;
                    // temp_v0_13->unk4 = 0x0400B510;
                    gSPDisplayList(D_801D9E88++, D_0400B510);
                    break;
                case 14:
                    // temp_v0_14 = D_801D9E88;
                    // D_801D9E88 = temp_v0_14 + 8;
                    // temp_v0_14->unk0 = 0x06000000;
                    // temp_v0_14->unk4 = 0x0400B560;
                ...
                // temp_v0_15 = D_801D9E88;
                // D_801D9E88 = temp_v0_15 + 8;
                // temp_v0_15->unk4 = 0;
        ...
        // temp_t2_4 = D_80204278;
        // temp_t0_3 = D_80204278->usedModelViewMtxs;
        if (((D_80204278->usedModelViewMtxs + 30) < 250) &&
            ...
            // temp_v0_20 = D_801D9E88;
            // D_801D9E88 = temp_v0_20 + 8;
            // temp_v0_20->unk0 = 0x01040040;
            // temp_t2_5 = D_80204278;
            // temp_v0_20->unk4 = (void *) (temp_t2_5 + (D_801D9E88->usedModelViewMtxs << 6) + 0x80033590);
            // temp_t2_6 = D_80204278;
            // temp_t2_6->usedModelViewMtxs = (s32) (temp_t2_6->usedModelViewMtxs + 1);

            // TODO: K0 macro
            gSPMatrix(D_801D9E88++, OS_K0_TO_PHYSICAL(&D_80204278->modelViewMtx[D_80204278->usedModelViewMtxs++]), G_MTX_PUSH | G_MTX_MUL | G_MTX_MODELVIEW);

            load_1_tile(D_0400BA20, D_0400B820);
            // temp_a3 = (s32) (D_803F2EC8 * 0x64) >> 6;
            func_802C78B0_6D8F60(0x14, 1, (D_803F2EC8 * 0x64) >> 6, (D_803F2EC8 * 0x64) >> 6, (D_803F2EC8 * 0x64) >> 6, (s32) D_803F2ED0, 0, 0, 0, D_0400A4E0);
            // temp_v0_21 = (s32) (spF8 * 0x445) >> 5;
            ...
            // temp_v0_22 = D_801D9E88;
            // D_801D9E88 = temp_v0_22 + 8;
            // temp_v0_22->unk0 = 0x06000000;
            // temp_v0_22->unk4 = sp7C;
            gSPDisplayList(D_801D9E88++, D_01003548);
            // temp_v0_23 = D_801D9E88;
            // D_801D9E88 = temp_v0_23 + 8;
            // temp_v0_23->unk4 = 0xFF717BFF;
            ...
            // temp_v0_24 = D_801D9E88;
            // D_801D9E88 = temp_v0_24 + 8;
            // temp_v0_24->unk0 = 0x06000000;
            // temp_v0_24->unk4 = 0x010034C0;
            ...
            // temp_v0_25 = D_801D9E88;
            // D_801D9E88 = temp_v0_25 + 8;
            // temp_v0_25->unk0 = 0x06000000;
            // temp_v0_25->unk4 = sp7C;
            gSPDisplayList(D_801D9E88++, D_01003548);
            // temp_v0_26 = D_801D9E88;
            // D_801D9E88 = temp_v0_26 + 8;
            // temp_v0_26->unk4 = 0x2000;
            // temp_v0_26->unk0 = 0xB6000000;
            gSPClearGeometryMode(D_801D9E88++, G_CULL_BACK);
            // temp_v0_27 = D_801D9E88;
            // D_801D9E88 = temp_v0_27 + 8;
            // temp_v0_27->unk4 = 0x1000;
            ...
            // temp_v0_28 = D_801D9E88;
            // D_801D9E88 = temp_v0_28 + 8;
            // temp_v0_28->unk0 = 0x06000000;
            // temp_v0_28->unk4 = sp74;
            gSPDisplayList(D_801D9E88++, D_010034C0);
            // temp_v0_29 = D_801D9E88;
            // D_801D9E88 = temp_v0_29 + 8;
            // temp_v0_29->unk4 = 0x2000;
            // temp_v0_29->unk0 = 0xB6000000;
            gSPClearGeometryMode(D_801D9E88++, G_CULL_BACK);
            // temp_v0_30 = D_801D9E88;
            // D_801D9E88 = temp_v0_30 + 8;
            // temp_v0_30->unk0 = 0xB7000000;
            // temp_v0_30->unk4 = 0x1000;
            gSPSetGeometryMode(D_801D9E88++, G_CULL_FRONT);
            ...
            if (D_803F2EDD == 0) {
                // temp_v0_31 = D_803D552C;
                // temp_a0_3 = D_803D552C->unk326;
                // D_803D552C->unk326++; // += 1; //(s16) (temp_a0_3 + 1);
                func_8031A150_72B800(D_803D552C->unk326++, &spFE, &spFC);
                func_8031A278_72B928(&D_803D552C->unk326, &spFE, &spFC);
                spFE = D_803BD5CC_7CEC7C[spFE];
                spFC = D_803BD684_7CED34[spFC];
                func_80356BD8_768288(D_01002C20, D_010025A0, spFE);
                // temp_v0_32 = D_801D9E88;
                // D_801D9E88 = temp_v0_32 + 8;
                // temp_v0_32->unk0 = 0x06000000;
                // temp_v0_32->unk4 = 0x010037F0;
                gSPDisplayList(D_801D9E88++, D_010037F0);

                // temp_a3_2 = (s32) (D_803F2EC8 * 0x64) >> 6;
                ...
                // temp_a3_3 = (s32) (D_803F2EC8 * 0x64) >> 6;
                func_802C78B0_6D8F60(1, 0x14, (D_803F2EC8 * 0x64) >> 6, (D_803F2EC8 * 0x64) >> 6, (D_803F2EC8 * 0x64) >> 6, (s32) D_803F2ED0, 0, 0, 0, D_0400B040);
                // temp_v0_33 = D_801D9E88;
                // D_801D9E88 = temp_v0_33 + 8;
                // temp_v0_33->unk0 = 0x06000000;
                // temp_v0_33->unk4 = 0x01003840;
                gSPDisplayList(D_801D9E88++, D_01003840);

            }
            // temp_v0_34 = D_801D9E88;
            // D_801D9E88 = temp_v0_34 + 8;
            // temp_v0_34->unk4 = 0;
            // temp_v0_34->unk0 = 0xBD000000;
            gSPPopMatrix(D_801D9E88++, G_MTX_MODELVIEW);
